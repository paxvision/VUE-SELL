  		...
  		<div class="content">
  			<div class="content-left">
  				<div class="logo-wrapper">
  					<div class="logo" :class="{'higelight':totalCount>0}">
  						<i class="icon-shopping_cart" :class="{'higelight':totalCount>0}"></i>
  					</div>
  					<div class="num" v-show="totalCount>0">{{totalCount}}</div>
  				</div>
  				<div class="price" :class="{'higelight':totalCount>0}">￥{{totalPrice}}</div>
